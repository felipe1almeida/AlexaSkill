    ...
    handle(handlerInput) {
        ...
        if (intent.confirmationStatus === 'CONFIRMED') {
            ...
            for (var i = 0; i < arrayRegistro.length; i++) {
                ...
                if (remedio === arrayRegistro[i].remedio) {
                    cadastrado = true;
                }
            }
...
const ApagarTratamentoIntentHandler = {
    ...
    handle(handlerInput) {
        ...
        if (arrayRegistro.length === 0 && contTratamento === 0) {
    ...
    handle(handlerInput) {
        ...
        if (arrayRegistro.length === 0 && contTratamento === 0) {
            ...
            for (var i = 0; i < arrayRegistro.length; i++) {
                ...
                if (arrayRegistro[i].tratamento === 0){
                speechText = speechText + ' Remédio ' + remedio + ' de ' + hora + ' em ' + hora + ' horas , durante ' + periodo + ' Dias, Este tratamento encerra dia ' + dia + '/' + mes
                }
